...
Version 1.2.5.3.6
- Generating copy of other clip as subclip will copy pelvis IK related settings properly
- Fix for GUI curves window to support curve shortcuts properly

Version 1.2.5.3.5
- Fixed curve effect for all modifiers (visible after expanding modifiers blend)
- Offset IK Goal module now is using animator transform local space for offsets

Version 1.2.5.3.4
- Changed how blending works for override rotation modifier

Version 1.2.5.3.3
- Added IK -> "Offset IK Goal" extra module

Version 1.2.5.3.2
- Added generic menu for more export options for the button "Save+"
