...
namespace FIMSpace.AnimationTools
{
    ...
    public class ADClipSettings_Main : IADSettings
    {
        ...
        public ADClipSettings_Main Copy(ADClipSettings_Main to, bool noCopy)
        {
            ...
            cpy.PelvisOffsetsBlend = to.PelvisOffsetsBlend;
            cpy.PelvisConstantYOffset = to.PelvisConstantYOffset;
            cpy.PelvisYOffset = to.PelvisYOffset;
            cpy.PelvisOffsetYEvaluate = AnimationDesignerWindow.CopyCurve( to.PelvisOffsetYEvaluate);
            cpy.PelvisXOffset = to.PelvisXOffset;
            cpy.PelvisOffsetXEvaluate = AnimationDesignerWindow.CopyCurve( to.PelvisOffsetXEvaluate);
            cpy.PelvisZOffset = to.PelvisZOffset;
            cpy.PelvisOffsetZEvaluate = AnimationDesignerWindow.CopyCurve( to.PelvisOffsetZEvaluate);
            cpy.IKGroundLevel = to.IKGroundLevel;
            cpy.IKGroundNormal = to.IKGroundNormal;
            cpy.OffsetHandsIKBlend = to.OffsetHandsIKBlend;
            cpy.TurnOnElasticness = to.TurnOnElasticness;
            
            if ( cpy.HipsElasticness != null && cpy.HipsElasticness.PositionMuscle != null && to.HipsElasticness != null && to.HipsElasticness.PositionMuscle != null)
            {
                cpy.HipsElasticness.PositionMuscle.Acceleration = to.HipsElasticness.PositionMuscle.Acceleration;
                cpy.HipsElasticness.PositionMuscle.AccelerationLimit = to.HipsElasticness.PositionMuscle.AccelerationLimit;
                cpy.HipsElasticness.PositionMuscle.Damping = to.HipsElasticness.PositionMuscle.Damping;
                cpy.HipsElasticness.PositionMuscle.BrakePower = to.HipsElasticness.PositionMuscle.BrakePower;
            }

            cpy.ElasticnessEvaluation = AnimationDesignerWindow.CopyCurve( to.ElasticnessEvaluation);
            cpy.ModsEvaluation = AnimationDesignerWindow.CopyCurve( to.ModsEvaluation );

            return cpy;
        }


        public void ApplySettingsOf( ADClipSettings_Main from )
        {
            PelvisOffsetXEvaluate = AnimationDesignerWindow.CopyCurve( from.PelvisOffsetXEvaluate );
            PelvisOffsetYEvaluate = AnimationDesignerWindow.CopyCurve( from.PelvisOffsetYEvaluate );
            PelvisOffsetZEvaluate = AnimationDesignerWindow.CopyCurve( from.PelvisOffsetZEvaluate );
            TurnOnElasticness = from.TurnOnElasticness;
            TurnOnIK = from.TurnOnIK;
            TurnOnMorphs = from.TurnOnMorphs;

            Export_DisableRootMotionExport = from.Export_DisableRootMotionExport;

            ResetRootPosition = from.ResetRootPosition;
            ClipDurationMultiplier = from.ClipDurationMultiplier;
            ClipSampleTimeCurve = AnimationDesignerWindow.CopyCurve( from.ClipSampleTimeCurve );
            ClipEvaluateTimeCurve = AnimationDesignerWindow.CopyCurve( from.ClipEvaluateTimeCurve );
            ClipTimeReverse = from.ClipTimeReverse;
            ClipTrimFirstFrames = from.ClipTrimFirstFrames;
            ClipTrimLastFrames = from.ClipTrimLastFrames;
            ResetRootPosition = from.ResetRootPosition;
            AdditionalAnimationCycles = from.AdditionalAnimationCycles;

            Additional_UseHumanoidMecanimIK = from.Additional_UseHumanoidMecanimIK;
            Export_LoopClip = from.Export_LoopClip;

            TurnOnModules = from.TurnOnModules;

            Export_ForceRootMotion = from.Export_ForceRootMotion;
            Export_DisableRootMotionExport = from.Export_DisableRootMotionExport;
            Export_JoinRootMotion = from.Export_JoinRootMotion;
            Export_ClipTimeOffset = from.Export_ClipTimeOffset;

            ElasticnesSettings = new ADClipSettings_Elasticness.ElasticnessSet();
            ElasticnesSettings.Enabled = from.ElasticnesSettings.Enabled;
            ElasticnesSettings.MoveDamping = from.ElasticnesSettings.MoveDamping;
            ElasticnesSettings.MoveMildRotate = from.ElasticnesSettings.MoveMildRotate;
            ElasticnesSettings.MoveRapidity = from.ElasticnesSettings.MoveRapidity;
            ElasticnesSettings.MoveSmoothing = from.ElasticnesSettings.MoveSmoothing;

            PelvisOffsetsBlend = from.PelvisOffsetsBlend;
            PelvisConstantYOffset = from.PelvisConstantYOffset;
            PelvisYOffset = from.PelvisYOffset;
            PelvisOffsetYEvaluate = AnimationDesignerWindow.CopyCurve( from.PelvisOffsetYEvaluate );
            PelvisXOffset = from.PelvisXOffset;
            PelvisOffsetXEvaluate = AnimationDesignerWindow.CopyCurve( from.PelvisOffsetXEvaluate );
            PelvisZOffset = from.PelvisZOffset;
            PelvisOffsetZEvaluate = AnimationDesignerWindow.CopyCurve( from.PelvisOffsetZEvaluate );
            IKGroundLevel = from.IKGroundLevel;
            IKGroundNormal = from.IKGroundNormal;
            OffsetHandsIKBlend = from.OffsetHandsIKBlend;
            TurnOnElasticness = from.TurnOnElasticness;

            if( HipsElasticness != null && HipsElasticness.PositionMuscle != null && from.HipsElasticness != null && from.HipsElasticness.PositionMuscle != null )
            {
                HipsElasticness.PositionMuscle.Acceleration = from.HipsElasticness.PositionMuscle.Acceleration;
                HipsElasticness.PositionMuscle.AccelerationLimit = from.HipsElasticness.PositionMuscle.AccelerationLimit;
                HipsElasticness.PositionMuscle.Damping = from.HipsElasticness.PositionMuscle.Damping;
                HipsElasticness.PositionMuscle.BrakePower = from.HipsElasticness.PositionMuscle.BrakePower;
            }

            ElasticnessEvaluation = AnimationDesignerWindow.CopyCurve( from.ElasticnessEvaluation );
            ModsEvaluation = AnimationDesignerWindow.CopyCurve( from.ModsEvaluation );
        }
