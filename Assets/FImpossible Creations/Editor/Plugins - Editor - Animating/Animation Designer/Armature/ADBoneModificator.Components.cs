...
namespace FIMSpace.AnimationTools
{
    public partial class ADClipSettings_Modificators
    {
        ...
        public partial class ModificatorSet
        {
            ...
            {
                float blendC = GetBlending(animationProgress, 1f) * set.AllModificatorsBlend * main.ModsEvaluation.Evaluate( animationProgress );
                if (T == null) return;
                ...
                else if (Type == EModification.OverrideRotation)
                {
                    ...
                    if (blend > 0f) T.localRotation = Quaternion.SlerpUnclamped( T.localRotation, Quaternion.Euler(RotationValue), blend);
                }
